declare function makeWASocket(config: any): {
    ...
    logger: import("@whiskeysockets/baileys/lib/Utils/logger").ILogger;
    ...
    updateBussinesProfile: (args: import("@whiskeysockets/baileys/lib/Types/Bussines").UpdateBussinesProfileProps) => Promise<any>;
    ...
    addLabel: (jid: string, labels: import("@whiskeysockets/baileys/lib/Types/Label").LabelActionBody) => Promise<void>;
    ...
    addOrEditQuickReply: (quickReply: import("@whiskeysockets/baileys/lib/Types/Bussines").QuickReplyAction) => Promise<void>;
    removeQuickReply: (timestamp: string) => Promise<void>;
    type: "md";
    ws: import("@whiskeysockets/baileys/lib/Socket/Client").WebSocketClient;
